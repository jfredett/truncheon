use ratatui::{layout::{Constraint, Layout, Rect}, style::{Color, Style}, Frame};
use crate::hex::{coord::axial, field::Field};
...
impl UI {
    ...
    // TODO: remove this in favor of bevy events.
    ...
    fn tui_logger_widget(&self) -> TuiLoggerSmartWidget<'_> {
